...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [{ title: "Autentificare admin · ZOL-OIL" }, { name: "robots", content: "noindex" }],
  }),
  component: AuthPage,
});
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-secondary">
      ...
      <div className="w-full max-w-md surface-card p-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Accesul la panoul de administrare este protejat prin Cloudflare Access. Autentificarea se
          face automat cu contul tău autorizat.
        </p>
        <Link
          to="/admin"
      ...
      <p className="mt-4 max-w-md text-center text-xs text-muted-foreground">
        Doar conturile autorizate în politica Cloudflare Access pot accesa panoul. Contactează
        proprietarul pentru acordarea accesului.
      </p>
    </div>
  );
}
