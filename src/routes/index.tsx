...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Parc Auto ZOL-OIL în Cernat, Covasna. Autoturisme rulate, verificate și pregătite pentru drum." },
...
function HomePage() {
  ...
  return (
    <div style={{ background: CREAM }}>
      ...
      {/* ===== POSTER HERO ===== */}
      <section style={{ position: "relative", overflow: "hidden", minHeight: "100svh", background: CREAM }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{
                ...
                color: DARK + "88", marginBottom: "0.75rem",
              }}>
              ...
              <p style={{
                ...
                lineHeight: 1.6, color: DARK + "99",
                maxWidth: "21rem",
              }}>
                Mașini verificate tehnic,<br />pregătite de drum.
              </p>
              <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.75rem", flexWrap: "wrap" }}>
                <Link
                  ...
                  style={{
                    ...
                    padding: "0.85rem 1.5rem", borderRadius: "9999px",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "9px", letterSpacing: "0.3em", textTransform: "uppercase", color: DARK + "35", marginBottom: "0.5rem" }}>—</div>
              <div style={{ fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 800, fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase", color: DARK }}>
                Parc Auto
              </div>
              ...
              <div style={{
                ...
                fontFamily: "'Sora', system-ui, sans-serif",
                fontWeight: 700, fontSize: "12px", color: DARK + "40",
              }}>
                01 / 50+
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 3rem)" }}>
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: "1.5rem" }}>
            {[
              ...
              <div key={l}>
                <div style={{ fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 900, fontSize: "1.75rem", letterSpacing: "-0.02em", color: CREAM }}>{v}</div>
                <div style={{ fontSize: "10px", letterSpacing: "0.18em", textTransform: "uppercase", color: CREAM + "50", marginTop: "0.1rem" }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ===== CARS GRID ===== */}
      <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "5rem clamp(1.25rem, 4vw, 3rem)" }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: "1rem", marginBottom: "2.5rem" }}>
          <div>
            <div style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: OG, marginBottom: "0.4rem" }}>
              Mașini disponibile
            </div>
            <h2 style={{ fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 900, fontSize: "clamp(1.8rem, 4vw, 3.2rem)", letterSpacing: "-0.03em", color: DARK, margin: 0 }}>
              {featured.length ? "Recomandate" : "Cele mai noi"}
            </h2>
          </div>
          <Link to="/masini" style={{ display: "inline-flex", alignItems: "center", gap: "0.3rem", fontSize: "0.85rem", fontWeight: 600, color: DARK + "70", textDecoration: "none" }}>
            Vezi toate <ArrowRight size={15} />
          </Link>
        </div>
        {shown.length === 0 ? (
          <div style={{ padding: "3rem", textAlign: "center", borderRadius: "1.5rem", background: DARK + "08", border: `1px solid ${DARK}12` }}>
      ...
      <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 3rem)", paddingBottom: "5rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1px", borderRadius: "1.5rem", overflow: "hidden", background: DARK + "15" }}>
          {[
            { icon: <ShieldCheck size={22} />, t: "Verificate tehnic", d: "Fiecare mașină este verificată înainte de a fi expusă spre vânzare." },
            { icon: <MapPin size={22} />, t: "Parc auto fizic", d: "Vino în Cernat să vezi mașina și să faci proba pe drum." },
            { icon: <Phone size={22} />, t: "Contact rapid", d: "Telefon, WhatsApp sau Messenger — îți răspundem repede." },
          ].map(({ icon, t, d }) => (
            <div key={t} style={{ background: CREAM, padding: "2rem", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <div style={{ color: OG }}>{icon}</div>
              <div style={{ fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 700, fontSize: "1rem", color: DARK }}>{t}</div>
      ...
      <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 3rem)", paddingBottom: "6rem" }}>
        <div className="grid gap-6 md:grid-cols-2">
          <div style={{ background: DARK + "07", border: `1px solid ${DARK}10`, borderRadius: "1.5rem", padding: "2.5rem" }}>
            <div style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: OG, marginBottom: "0.5rem" }}>Locație</div>
            <h2 style={{ fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 900, fontSize: "1.9rem", letterSpacing: "-0.02em", color: DARK, margin: "0 0 0.75rem" }}>
              Parcul auto din {SITE.city}
            </h2>
            <p style={{ fontSize: "0.875rem", color: DARK + "80", lineHeight: 1.6 }}>
              {SITE.address}. Te așteptăm să vezi mașinile pe viu și să faci proba pe drum.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.6rem", marginTop: "1.5rem" }}>
              <a href={SITE.mapsDirections} target="_blank" rel="noreferrer"
                style={{ background: DARK, color: CREAM, padding: "0.6rem 1.25rem", borderRadius: "9999px", fontSize: "0.825rem", fontWeight: 700, textDecoration: "none" }}>
                Direcții Google Maps
              </a>
              <a href={SITE.waze} target="_blank" rel="noreferrer"
                style={{ border: `1.5px solid ${DARK}28`, color: DARK, padding: "0.6rem 1.25rem", borderRadius: "9999px", fontSize: "0.825rem", fontWeight: 700, textDecoration: "none" }}>
                Deschide în Waze
              </a>
            </div>
          ...
          <div style={{ borderRadius: "1.5rem", overflow: "hidden", minHeight: "320px", border: `1px solid ${DARK}10` }}>
            <iframe title="Hartă" src={SITE.mapsEmbed} style={{ width: "100%", height: "100%", minHeight: "320px", display: "block" }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </div>
      </section>
    </div>
